...
namespace CreateWorkbooks
{
    public partial class ThisAddIn
    {
        ...
        private void ThisAddIn_Startup(object sender, System.EventArgs e)
        {
            ...
            xl.Visible = true;
            Excel.Workbook wb = xl.Workbooks.Open("C:/Users/ccrowe/Documents/workbooks to create.xlsm");
            Excel.Worksheet ws = wb.Sheets["Sheet1"];
            Excel.Workbook exWb = xl.Workbooks.Open("C:\\Users\\ccrowe\\Desktop\\Template.xlsm");
            ...
            wb.Close(false);
            exWb.Close(false);
            for (int i = 2; i <= 195; i++)//These are the rows in "workbooks to create.xlsm" I will traverse
                // ws.UsedRange.Rows.Count //Edit this for which workbooks (names and descriptions) you wish to create
            {
                wb = xl.Workbooks.Open("C:/Users/ccrowe/Documents/workbooks to create.xlsm");
                ...
                ws = wb.Sheets["Sheet1"];
                exWb = xl.Workbooks.Open("C:\\Users\\ccrowe\\Desktop\\Template.xlsm");

                string fileNumber = ws.get_Range("A" + i.ToString()).Value2;
                //Get the JCMS Description
                SqlConnection conn =
                    new SqlConnection(
                        "Server=(LocalDB)\\MSSQLLocalDB;Database=JCMS_Local_41;Integrated Security = true");
                conn.Open();
                string sql = string.Format(
                    @"SELECT Element_Descr
                FROM Element where Element_Nbr = '{0}';
                ", fileNumber);
                ...
                string fullPath = Path.Combine("C:\\Users\\ccrowe\\Desktop\\New Workbooks",
                    fileName,
                    fileName + ".xlsx");
                ...
                if (!exists)
                {
                    ...
                    wb.Close(false);
                    if (!File.Exists("C:\\Users\\ccrowe\\Desktop\\New Workbooks\\" + fileName))
                    {
                ...
                ", fileNumber);
                        ...
                        dest = wbs.Range["A96:B100"];
                        source.Copy();
                        wbs.Activate();
                        wbs.Range["A96"].Select();
                        wbs.Paste();


                        int topOfLegend = 91;
                        source = wbsSource.Range["A28:E28"];
                        dest = wbs.Range["A92:E92"];
                        source.Copy();
                        wbs.Activate();
                        wbs.Range["A92"].Select();
                        wbs.Paste();

                        wbs.Rows[92].RowHeight = wbsSource.Rows[28].RowHeight;
                        (wbs.Rows[92] as Excel.Range).WrapText = false;
                        for (int a = 2; a <= 91; a++)
                        {
                        ...
                        wbs.Range["A96:B96"].Font.Bold = false;
                        //DRAWINGS
                ...
                ", fileNumber);
                        ...
                        dest = bom.Range["A127:B131"];
                        source.Copy();
                        bom.Activate();
                        bom.Range["A127"].Select();
                        bom.Paste();

                        topOfLegend = 122;
                        source = bomSource.Range["A125:T125"];
                        dest = bom.Range["A123:T123"];
                        source.Copy();
                        bom.Activate();
                        bom.Range["A123"].Select();
                        bom.Paste();

                        bom.Rows[123].RowHeight = bomSource.Rows[125].RowHeight;
                        (bom.Rows[123] as Excel.Range).WrapText = false;
                        for (int rn = 127; rn < 132; rn++)
                        {
                            bom.Rows[rn].RowHeight = exWb.Sheets["Bill of Materials"].Rows[rn + (471 - 127)].RowHeight;
                        }
                ...
                ", fileNumber);
                            ...
                            do
                            {
                                while (reader.Read())
                                {
                                    ...
                                    DirectoryInfo caWeFolder =
                                        new DirectoryInfo(@"C:\Users\ccrowe\Desktop\CA Work Elements");
                                            ...
                                            if (weWs.Range["B" + row.ToString()].Value != null)
                                            {
                                                ...
                                                if (topCellColor == Color.FromArgb(141, 180, 226))
                                                {
                                                    if (secondCellColor ==
                                                        ...
                                                        //Condition 3
                                                    {
                                                        We we = new We(weWs.Range["B" + row.ToString()].Value,
                                                            weWs.Range["B" + (row + 1).ToString()].Value,
                                                            weWs.Range["B" + (row + 2).ToString()].Value,
                                                            weWs.Range["B" + (row + 3).ToString()].Value);
                                                        ...
                                                        if (weWs.Range["H" + row.ToString()].Value != null)
                                                        {
                                                            ...
                                                            {
                                                                we.Quantity =
                                                                    (double) weWs.Range["H" + row.ToString()].Value;
                                                            }
                                                            else if (type.ToString() == "System.Double")
                                                            {
                                    ...
                                    foreach (var we in ca.WeList)
                                    {
                                        ...
                                        bom.Range["F" + curBomRow.ToString()].Formula = "=IF($E" + curBomRow.ToString() +
                                                                                        "=\"\",\"\",VLOOKUP($E" +
                                                                                        curBomRow.ToString() +
                                        ...
                                        res.Range["D" + curResRow.ToString()].Value = "=IF(H" + curResRow.ToString() +
                                                                                      ...
                                                                                      caResRow.ToString() + ")";
                                        //caResRow
                                        res.Range["F" + curResRow.ToString()].Formula = "=IF($E" + curResRow.ToString() +
                                                                                        "=\"\",\"\",VLOOKUP($E" +
                                                                                        curResRow.ToString() +
                                                                                        ",CostBook!$A$2:$W$3000,4,FALSE)&\" - \"&VLOOKUP($E" +
                                                                                        curResRow.ToString() +
                                                                                        ",CostBook!$A$2:$W$3000,5,FALSE))";
                                        res.Range["G" + curResRow.ToString()].Formula = "=IF($E" + curResRow.ToString() +
                                                                                        "=\"\",\"\",VLOOKUP($E" +
                                                                                        curResRow.ToString() +
                                                                                        ",CostBook!$A$2:$W$3000,6,FALSE))";
                                        res.Range["I" + curResRow.ToString()].Formula = "=IF(H" + curResRow.ToString() +
                                                                                        "=\"\",\"\",D" +
                                                                                        curResRow.ToString() +
                                                                                        "*H" + curResRow.ToString() +
                                                                                        ")";
                                        res.Range["J" + curResRow.ToString()].Formula = "=IF($I" + curResRow.ToString() +
                                                                                        "=\"\",\"\",$I" +
                                                                                        curResRow.ToString() +
                                                                                        "*VLOOKUP($E" +
                                                                                        curResRow.ToString() +
                                                                                        ",CostBook!$A$2:$W$3019,11,FALSE))";
                                        res.Range["K" + curResRow.ToString()].Formula = "=IF($I" + curResRow.ToString() +
                                                                                        "=\"\",\"\",$I" +
                                                                                        curResRow.ToString() +
                                                                                        "*VLOOKUP($E" +
                                                                                        curResRow.ToString() +
                                                                                        ",CostBook!$A$2:$W$3019,13,FALSE))";
                                        res.Range["L" + curResRow.ToString()].Formula = "=IF($I" + curResRow.ToString() +
                                                                                        "=\"\",\"\",$I" +
                                                                                        curResRow.ToString() +
                                                                                        "*VLOOKUP($E" +
                                                                                        curResRow.ToString() +
                                                                                        ",CostBook!$A$2:$W$3019,15,FALSE))";
                                        res.Range["M" + curResRow.ToString()].Formula = "=IF($I" + curResRow.ToString() +
                                                                                        "=\"\",\"\",$I" +
                                                                                        curResRow.ToString() +
                                                                                        "*VLOOKUP($E" +
                                                                                        curResRow.ToString() +
                                                                                        ",CostBook!$A$2:$W$3019,17,FALSE))";
                                        res.Range["N" + curResRow.ToString()].Formula = "=IF($I" + curResRow.ToString() +
                                                                                        "=\"\",\"\",$I" +
                                                                                        curResRow.ToString() +
                                                                                        "*VLOOKUP($E" +
                                                                                        curResRow.ToString() +
                                                                                        ",CostBook!$A$2:$W$3019,19,FALSE))";
                                        res.Range["O" + curResRow.ToString()].Formula = "=IF($I" + curResRow.ToString() +
                                                                                        "=\"\",\"\",$I" +
                                                                                        curResRow.ToString() +
                                                                                        "*VLOOKUP($E" +
                                                                                        curResRow.ToString() +
                                                                                        ",CostBook!$A$2:$W$3019,21,FALSE))";
                                        res.Range["P" + curResRow.ToString()].Formula = "=IF($I" + curResRow.ToString() +
                                                                                        "=\"\",\"\",$I" +
                                                                                        curResRow.ToString() +
                                                                                        "*VLOOKUP($E" +
                                                                                        curResRow.ToString() +
                        ...
                        bom.Range["A127:B127"].Font.Bold = false;
                        bom.Range["B128:B131"].Borders[Excel.XlBordersIndex.xlEdgeRight].Weight =
                            Microsoft.Office.Interop.Excel.XlBorderWeight.xlMedium;
                        RemoveEmptyRows(topOfLegend, bom);
                        //wbs stuff
                        wbs.Activate();
                        topOfLegend = 91; //for wbs
                                ...
                                if (!xl.WorksheetFunction.IsError(cell))
                                {
                                    if (cell.Text.ToString().Contains("."))
                                    {
                                        ...
                                        if (
                                            ss.Length > 4)
                                        {
                                            MessageBox.Show("Error in BOM col R/S number of decimals, row:" + cell.Row);
                                        }
                                    }
                                }
                            }
                                ...
                                if (!xl.WorksheetFunction.IsError(cell))
                                {
                                    if (cell.Text.ToString().Contains("."))
                                    {
                                        ...
                                        if (
                                            ss.Length > 2)
                                        {
                                            MessageBox.Show("Error in BOM col T number of decimals, row:" + cell.Row);
                                        }
                                    }
                                }
                            }
                        ...
                        dest = res.Range["A77:B80"];
                        source.Copy();
                        res.Activate();
                        res.Range["A77"].Select();
                        res.Paste();

                        res.Range["A77:B77"].Merge();

                        topOfLegend = 72;
                        source = reSource.Range["A29:V29"];
                        dest = res.Range["A73:V73"];
                        source.Copy();
                        res.Activate();
                        res.Range["A73"].Select();
                        res.Paste();
                        (res.Rows[73] as Excel.Range).WrapText = false;

                        for (int j = 22; j <= 19 + maxFurthest; j++)
                        {
                            source = res.Range["T73"];
                            dest = res.Cells[73, j];
                            source.Copy();
                            res.Cells[73, j].Select();
                            res.Paste();
                        }

                        for (int rn = 77; rn < 123; rn++)
                        {
                            res.Rows[rn].RowHeight = exWb.Sheets["Resources"].Rows[rn + (118 - 77)].RowHeight;
                        }
                        res.Range["F1"].Select();
                        for (int a = 3; a <= 72; a++)
                        {
                        ...
                        res.Range[res.Cells[1, 19 + maxFurthest], res.Cells[lastEdgeRow, 19 + rememberCol]].Borders(Excel.XlBordersIndex.xlEdgeRight).Weight =
                            Microsoft.Office.Interop.Excel.XlBorderWeight.xlMedium;
                        res.Range[res.Cells[1, 19 + maxFurthest], res.Cells[lastEdgeRow, 19 + rememberCol]].Borders(Excel.XlBordersIndex.xlEdgeRight).LineStyle =
                            Microsoft.Office.Interop.Excel.XlLineStyle.xlContinuous;
                        ...
                        bom.Range[bom.Cells[1,20], bom.Cells[lastEdgeRow, 20]].Borders(Excel.XlBordersIndex.xlEdgeRight).Weight =
                            Microsoft.Office.Interop.Excel.XlBorderWeight.xlMedium;
                        bom.Range[bom.Cells[1, 20], bom.Cells[lastEdgeRow, 20]].Borders(Excel.XlBordersIndex.xlEdgeRight).LineStyle =
                            Microsoft.Office.Interop.Excel.XlLineStyle.xlContinuous;
                        bom.Activate();
                ...
                ", fileNumber);
                        ...
                        xl.DisplayCommentIndicator = Excel.XlCommentDisplayMode.xlCommentIndicatorOnly;//turn off all comments, I am less than confident that the above loop works
                        ...
                        string baseDirPath = Path.Combine("C:\\Users\\ccrowe\\Desktop\\New Workbooks",
    fileName.ToString().Replace(".xlsx", "").Replace(".xlsm", "").Replace("/","-"));
            ...
            //exWb.Close(false);
                ...
                Office.COMAddIn addIn =
                    comAddIns.Cast<Office.COMAddIn>()
                        .FirstOrDefault(
                            addin =>
                                string.Equals(addin.Description, "CreateWorkbooks", StringComparison.OrdinalIgnoreCase));
                addIn.Connect = false;
                xl.Quit();
        }
        ...
        public void RemoveEmptyRows(int topOfKey,Excel.Worksheet ws)
        {
            ws.Activate();
        ...
        public void addValidation(Excel.Worksheet ws, string columnLetter)
        ...
        public void addValidation2(Excel.Worksheet ws, string columnLetter)
        {//"IsText(" + xl.ActiveCell.Value.ToString() + ")"
            var val = new Random();
            var rnCells = ws.Columns[columnLetter];
            rnCells.Validation.Delete();
